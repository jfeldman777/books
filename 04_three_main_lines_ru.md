...
Так возникает модель конвейера задач. Конвейер здесь не в голове у ученика. Конвейер - это внешняя лента, по которой к ученику поступают задачи. А мы наблюдаем, как он с ними справляется.
...
А три модели - Разогрев, Кодировки и Уровни - относятся к дифференциальной психологии: они описывают, чем люди отличаются друг от друга и почему один человек справляется с задачей иначе, чем другой.
